...
import UpdateInfoPaciente from './src/pages/PerfilPaciente/Informacao/UpdateInfoPaciente';
    ...
    <FormProvider2>
     <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="UpdateInfoPaciente" component={UpdateInfoPaciente} options={{ title: "", headerShown:false }} />
